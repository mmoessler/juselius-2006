...
Note, the function `ca_jo_jus06_fun()` is based on the function `ca.jo()` from the library `urca` (see also @Pfaff2008Analysis). The dummy variables are added inside the function, i.e., "hard". Check the code on *GitHub* for more information.
